...
interface EditLaboratoryProps {
    laboratory: Laboratory;
}

export default function EditLaboratory({ laboratory }: EditLaboratoryProps) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/admin/laboratories/${laboratory.id}`);
    };
        ...
        >
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-muted-foreground">Atualizar informações do laboratório</p>
                </div>
