...
export default function EditExamType({ examType }: EditExamTypeProps) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        put(`/admin/exam-types/${examType.id}`);
    };
    ...
    return (
        <AdminLayout
            breadcrumbs={[
                ...
                { label: 'Editar Tipo de Exame' },
            ]}
        >
            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-bold">Editar Tipo de Exame</h1>
                    <p className="text-muted-foreground">Atualizar informações do tipo de exame</p>
                </div>
