...
class StandardReferenceRangeSeeder extends Seeder
{
    /**
    ...
    {
        // Clear existing data
        DB::table('standard_reference_ranges')->delete();
        ...
        foreach ($references as $reference) {
            StandardReferenceRange::create($reference);
        }

        $this->command->info('Standard reference ranges seeded successfully!');
        $this->command->info('Total references created: ' . count($references));
    }
}
